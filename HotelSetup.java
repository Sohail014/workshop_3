package com.bridgelab.workshop3;
...
public class HotelSetup {
    ...
    //UC6  (Rating)
    public void findCheapestHotelRatingForRegular(String startDateRange, String endDateRange) {                                                      //Find CheapestHotel best Rated based on weekendRegularRate
        ...
        hotel.setHotelName(cheapestHotel.get().getHotelName());
        hotel.setTotal(cheapestHotel.get().getWeekendRegularRate() * numberOfDays);                           //numberOfDays = for eg-(5*90)
        hotel.setRating(cheapestHotel.get().getRating());                                                 //Setting rating for the cheapesthotel
    ...
    //UC9-UC10  (Reward Rates)  WeekdayRewardRate
